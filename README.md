...
Rigenera i dati, compila l'app se serve, la serve su `http://localhost:8770` e
apre il browser. Nessun server di sviluppo, nessun websocket.
...
npm test           # 181 test di parità col motore Python originale
...
Excel a 3 fogli sono portati e verificati con **181 test di parità** contro il
